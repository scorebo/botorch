...
class qLowerBoundMaxValueEntropy(DiscreteMaxValueBase):
    ...
    def _compute_information_gain(
        ...
        cond_means = prev_m.mean
        cond_variances = prev_m.variance
        ...
        covar_mM = covar_mM.unsqueeze(-1)
        variance_M = variance_M.unsqueeze(-1).unsqueeze(-1)
        ...
        acq = acq.mean(dim=-2).unsqueeze(0).squeeze(-1)
